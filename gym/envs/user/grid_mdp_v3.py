...
class GridEnv1(gym.Env):
    ...
    def __init__(self):
        ...
        #未知元素的reward
        self.rewards['3_1'] = -100.0
        self.rewards['6_3'] = -100.0
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            #创建未知火坑
            self.unknow = rendering.make_circle(40)
            self.circletrans = rendering.Transform(translation=(450, 350))
            self.unknow.add_attr(self.circletrans)
            self.unknow.set_color(0, 0, 0)
            ...
            self.viewer.add_geom(self.unknow)
