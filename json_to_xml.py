...
# 1.标签路径
labelme_path = "./data/Json/"
#原始labelme标注数据路径
saved_path = "./VOCdevkit/"
# 保存路径
...
for json_file_ in files:
    ...
    height, width, channels = cv2.imread('./data/VOCdevkit/JPEGImages/' + json_file_ + ".jpg").shape
...
image_files = glob("./VOCdevkitJPEGImages" + "*.jpg")
...
total_files = glob("./VOCdevkit/Annotations/*.xml")
